    ...
    public void run() {
        try {
            ...
            if (serverChannelFuture.isSuccess()) {
                MinetraxBukkit.getPlugin().getLogger().info("WebQuery Server started successfully on port " + port);
            }
            ...
            MinetraxBukkit.getPlugin().getLogger().warning("WebQuery Server interrupted: " + e.getMessage());
